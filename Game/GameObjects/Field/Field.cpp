...
void Field::Render()
{
	...
	//// 反転
	//DirectX::SimpleMath::Quaternion rot = DirectX::SimpleMath::Quaternion::CreateFromAxisAngle(DirectX::SimpleMath::Vector3::UnitX, XMConvertToRadians(180));
	//DirectX::SimpleMath::Matrix rSWorld = DirectX::SimpleMath::Matrix::CreateFromQuaternion(rot) * sWorld;
