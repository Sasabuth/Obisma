...
/// コンストラクタ
/// </summary>
EnemyThrowing::EnemyThrowing(Enemy* enemy)
	: m_enemy(enemy)
...
void EnemyThrowing::Update(float elapsedTime)
{
	...
	//if (!m_isThowing)
	//{
	//	Ball& ball = m_enemy->GetScene()->GetBall();
...
void EnemyThrowing::Render()
{
	...
	debugFont->Render(L"EnemyThrowing");
}
...
/// </summary>
/// <param name="elapsedTime">経過時間</param>
void EnemyThrowing::AnimationUpdate(float elapsedTime)
{
	// アニメションにモデルを適用する
