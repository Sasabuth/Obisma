...
public:
	...
	// BGMの音量
	void SetBGMVolume(float volume) { m_bgmVolume = volume; }  // 設定
	float GetBGMVolume() const { return m_bgmVolume; }		   // 取得
	// SEの音量
	void SetSEVolume(float volume) { m_seVolume = volume; }    // 設定
	float GetSEVolume() const { return m_seVolume; }		   // 取得
